...
final class EditProfileViewController: UIViewController, UITableViewDataSource {
    ...
    private let tableView: UITableView = {
        ...
        tableView.register(FormatTableViewCell.self, forCellReuseIdentifier: FormatTableViewCell.identifier)
        return tableView
    }()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: FormatTableViewCell.identifier, for: indexPath) as! FormatTableViewCell
...
extension EditProfileViewController: FormatTableViewCellDelegate {
